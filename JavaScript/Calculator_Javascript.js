...
function Input_Decimal(dot) {
    //This ensures that accidental clicking of the deicmal point doesn't
    //cause bugs in the operation
    if (Calculator.Wait_Second_Operand === true) return;
    if (!Calculator.Display_Value.includes(dot)) {
        //We are saying that if the Decimal_Value does not contain a decimal point
...
//This section handles operators
    function Handle_Operator(Next_Operator) {
        ...
        //When an operator key os pressed we convert the current number
    ...
    //This function updates the calculator-screen wit the contents of Display_Value
